...
{% set netbox_secret = salt['pillar.bet']('netbox_secret', [])
{% set redis_cache_password = salt['pillar.get']('redis_cache_password', [])
{% set redis_password = salt['pillar.get']('redis_password', [])
